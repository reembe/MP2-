...
public class Games implements ActionListener{
    ...
    public void mcQuiz()
    {
        ...
        {
            String[] qf = {"1. How many pronouns are there?", 
            "2. What are the basic conjugates?", 
            "3. What tense is for a continuous past event?", 
            "4. How many francaphone countries are there?", 
            "5. How do you conjugate an IR verb using the nous pronoun?", 
            "6. How do you say Hello in french?", 
            "7. How many tenses are there?", 
            "8. Who is the best french actor (Alive)?", 
            "9. When was the first appearence of french in records?", 
            "10. Quel est le nom de notre prof de class?"};
        }
        if (language.equals("spanish"))
        {
            ...
            "6. Which of the following greets means \"good morning\" in Spanish?", 
            "7. How do you conjuagate the yo form of the verb \"correr\" in the present tense?", 
